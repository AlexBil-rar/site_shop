...
const Cooperation = () => {
    ...
    return(
		<div>
			...
			<svg display="none">
				<symbol id="cooperation" viewBox="0 0 512 512">
				<g>
		<g>
	...
	<g>
				...
				<svg className="icon-delivery">
					<use xlinkHref="#cooperation"></use>
				</svg>
				<p className="mine_text">Сотрудничество</p>
			</div>
			<hr className="line"/>
			<div className="text-info_2">
				<div style={{display: 'block'}}>
					<img src={'/images/Igoran.png'} alt="" />
					<div className="Name"><p style={{ fontWeight: 500, fontSize: 17}}><span style={{display: 'block', marginTop: 10}}>Харитонов Игорь</span> <span style={{display: 'block'}}> Основатель скейтшопа</span> В городе Набережные Челны</p></div>
				</div>
				<div >
					<p className="Igor_say">Привет! Меня зовут Игорь и моя история становления на доску начинается в 2012 году. Скейтбординг всегда привлекал меня своей тусовостью, движухой, в которой нет рамок и границ, ведь тут без разницы сколько тебе лет, какой у тебя социальный статус, в этой культуре все равны между собой.</p>
					<p className="Igor_say">Из-за любви к данному движению в 2016 году был организован мною небольшой локальный скейтшоп "На колёсах" в городе Набережные Челны. Это был первый и единственный Скейтшоп в моем городе. Сейчас на дворе 2021 год и мы путешествуем и катаемся по всей России с нашей командой райдеров. Мы начали производить свои собственные доски и шкурки. Отправляем заказы ежедневно по всей России и странам СНГ.
					Сейчас я со своей командой на пути создания полноценного скейт бренда по производству досок, шкурок, колёс и подшипников. В свою команду я привлек современных дизайнеров и ребят, которые будут тщательно производить тест-драйв скейтов и давать свои рекомендации по улучшению. Качество изготавливаемого стафа будет на уровне известных отечественных и зарубежных производителей скейтбордов, но при этом с приемлемой ценой для райдеров РФ и СНГ</p>
					<p className="Igor_say">Если ты хочешь стать частью нашей команды и семьи, то пиши нам на почту shopnakolesah@gmail.com со своим предложением! Мы готовы рассмотреть любое Ваше предложение, ведь вместе мы выведем Скейтбординг на новый уровень в нашей стране!</p>
				</div>
			</div>
